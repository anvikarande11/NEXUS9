...
export const metadata: Metadata = {
  title: 'Nexus-Uni — The Scholar\'s Command Center',
  description: 'A premium student operating system combining the depth of Notion, clarity of Linear, and academic context of Canvas LMS.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
